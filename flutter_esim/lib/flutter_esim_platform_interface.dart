...
abstract class FlutterEsimPlatform extends PlatformInterface {
  ...
  Future<bool> installEsimProfile(String profile) {
    throw UnimplementedError('installEsimProfile() has not been implemented.');
  }

  Future<bool> openUniversalLink(String activationCode) {
    throw UnimplementedError('openUniversalLink() has not been implemented.');
  }
