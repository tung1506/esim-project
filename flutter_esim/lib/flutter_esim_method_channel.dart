...
class MethodChannelFlutterEsim extends FlutterEsimPlatform {
  ...
  Future<bool> installEsimProfile(String profile) async {
    final result = await methodChannel
        .invokeMethod<bool>('installEsimProfile', {'profile': profile});
    return result ?? false;
  }

  @override
  Future<bool> openUniversalLink(String activationCode) async {
    final result = await methodChannel
        .invokeMethod<bool>('openUniversalLink', activationCode);
    return result ?? false;
  }
